function path = extractSkeletonPath(MSTMap, pgons, d, MagFactor, Lsize, Hsize, npol)
% extractSkeletonPath - Extrai o caminho esquelético de um mapa binarizado com obstáculos
%
% Entradas:
%   MSTMap      - Mapa RGB original
%   pgons       - Célula com polígonos (obstáculos)
%   d           - Parâmetro de escala (ex. largura de aresta)
%   MagFactor   - Fator de ampliação
%   Lsize,Hsize - Dimensões originais do mapa
%   npol        - Número de obstáculos
%   debug       - Flag booleana para mostrar imagens
%   DilatHndl   - Handle da figura da dilatação
%   BorderHndl  - Handle da figura da fronteira
%
% Saída:
%   path        - Caminho esquelético extraído (Nx2), com coordenadas reescaladas
